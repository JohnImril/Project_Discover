...
exports.default = gulp.parallel(watch, gulp.series(clean, js, svg, pug, stylus, images, server));
exports.server = server;
exports.clean = clean;
exports.build = gulp.series(clean, js, svg, pug, images, stylus);
exports.dev = gulp.parallel(watch, gulp.series(clean, js, pug, svg, stylus, images, server));
